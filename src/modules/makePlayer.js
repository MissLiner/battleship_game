...
const playerFactory = (name, isComputer, oppBoard) => {
  ...
  return { name, getShips, placeShip, getArmada, makeGuess, checkForDupes, findOpenSpaces, getAllShipPositions, pickDirection, isComputer, takeAITurn, autoBuildArmada };
}
